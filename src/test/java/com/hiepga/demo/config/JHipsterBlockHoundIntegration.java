package com.hiepga.demo.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hiepga.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hiepga.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
